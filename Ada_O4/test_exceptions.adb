-- aleny404: Samarbetat med johsa420, Johanna Sandén, samma program
...
procedure Test_Exceptions is
   ...
   procedure Put_Month_Day(Value : in Integer) is
   ...
   begin
      ...
      Put('-');
      Put_Month_Day(Item.Month);
      Put('-');
      Put_Month_Day(Item.Day);
   end Put;
   ...
   procedure Check_Dash(C : in Character)is
   ...
   begin
	 ...
	 when Length_Error =>
      ...
      Check_Dash(Date_Str(5));
      
      Format_Str(Date_Str(6 .. 7), Month_Int);
      
      Check_Dash(Date_Str(8));
