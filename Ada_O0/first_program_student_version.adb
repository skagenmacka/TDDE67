...
procedure First_Program_Student_Version is
...
begin
   ...
   Put_Line("Skriv in det hemliga lösenordet här: [Ordet lösenordet är kanske felstavat]");
end First_Program_Student_Version;
